...
type SuccessProp = {
	onClick: () => void
	offer: 'done' | 'notification' //done - Ваше предложение создано, notification - Вы предложили обмен
}
		...
		<div className={styles.container}>
			{offer === 'done' ? (
				<figure className={styles.figure}>
					<img className={styles.image} src='/icons/Done.svg' alt='' />
					<figcaption>
				...
				<figure className={styles.figure}>
					<img className={styles.image} src='/icons/notification.svg' alt='' />
					<figcaption>
