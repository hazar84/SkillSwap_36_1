...
import { selectExchangesSentByUser, selectExchangesReceivedByUser } from '../../features/skill-exchange/model/skill-exchange-slice'
...
export const MyExchange: React.FC = () => {
  ...
  const uniqueUserIds = Array.from(new Set(exchangeUserIds)).filter(id => id !== userId);
